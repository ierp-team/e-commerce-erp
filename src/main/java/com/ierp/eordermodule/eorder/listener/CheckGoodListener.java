...
@Component
@Transactional
public class CheckGoodListener implements TaskListener{
    ...
    public void notify(DelegateTask delegateTask) {
        ...
        if(delegateTask.getVariable("isQualified").toString() =="false") {
            eOrder.setOrderStatus(EOrderStatus.CANCEL);
            eOrder.setCancelTime(new Date());
        }
    }
