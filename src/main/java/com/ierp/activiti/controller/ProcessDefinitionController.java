package com.ierp.activiti.controller;
...
import com.ierp.activiti.domain.ProcessDefinitionDTO;
...
public class ProcessDefinitionController {
    ...
    @PostMapping
    public ExtAjaxResponse deploy(@RequestParam(value="file",required = true)MultipartFile file){
    ...
    @DeleteMapping
    public   ExtAjaxResponse deleteProcessDefinition(@RequestBody String deploymentId) {
        try {
